...
DECAY_FACTOR     = 0.985           # per-tick decay of signal strength

# ── Sizing ───────────────────────────────────────────────────────────────
SCALP_BASE       = 300             # base contracts per scalp at full t and ATM
EDGE_INSIDE      = 1              # ticks inside best bid/ask for passive

# ── Thresholds ───────────────────────────────────────────────────────────
IV_NOISE_FLOOR   = 0.0005          # 10 bps IV minimum residual to consider
...
VANNA_TOL              = 10         # neutralize when |net_vanna| > this
VANNA_HEDGE_PASSIVE    = 40         # contracts/tick passive hedge orders
VANNA_HEDGE_AGGRESSIVE = 300         # contracts/tick aggressive (cross) hedge
